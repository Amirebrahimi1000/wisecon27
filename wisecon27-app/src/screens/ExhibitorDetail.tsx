    ...
    <div style={{ paddingBottom: TABBAR_H + 16 }}>
      <div style={{ padding: STATUS_INSET + 8 + 'px 18px 24px', background: `color-mix(in srgb, ${sp.color} 78%, #000)`, color: '#fff' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <Eyebrow color="rgba(255,255,255,0.8)">{sp.tier} sponsor</Eyebrow>
      ...
      <div style={{ padding: '20px 16px 0', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        {sp.website && (
          ...
          >
            <Icon name="arrowRight" size={18} stroke={2} />Visit website
          </a>
        )}
        {!sp.description && !sp.booth && !sp.website && (
          <p style={{ fontFamily: T.sig, fontSize: 14.5, color: T.muted, lineHeight: 1.5 }}>More details about this exhibitor are coming soon.</p>
        )}
      </div>
    </div>
  )
