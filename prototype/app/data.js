/* WISEcon27 — event content. Plausible placeholder data; swap for real content later. */
(function () {
  const TRACKS = {
  ...
  // type: keynote | talk | panel | workshop | break | social
  const SESSIONS = [
    // ── Day 1 ──
  ...
  window.DATA = { TRACKS, DAYS, SPEAKERS, SESSIONS, ATTENDEES, NOTIFICATIONS, SPONSORS, ME };
})();
